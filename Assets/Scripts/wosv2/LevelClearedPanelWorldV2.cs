namespace MiniGame.WorldOfShape
{
    ...
    public class LevelClearedPanelWorldV2 : MonoBehaviour
    {
        ...
        public void RepeatGame()
        {
            ...
            Handheld.Vibrate();
            GameManagerWorldV2.instance.clearedLevels = 0;
            // GamePlayPanelWorldV2.instance.miniLevel = 0;
            GameManagerWorldV2.instance.ResetMiniLevel();
